...
> 대상 기준: Mackor 1.4 (빌드 10) 현재 작업 트리  
> 작성일: 2026-07-20 (최종 갱신 2026-07-25)
...
- [ ] Safari/Chrome 주소창에서 Enter·Tab 제출 시에는 삭제·주입·입력 소스 전환이 없고, 스페이스 경계와 일반 검색 입력란에서는 자동 교정이 동작한다.
